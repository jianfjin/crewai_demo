...
def cross_sectional_analysis(data_path: str = None, group_column: str = "brand", value_column: str = "sales") -> str:
    ...
    try:
        ...
        # Use parameters from input data
        segment_column = group_column
...
@tool
def analyze_kpis(input_data: KPIAnalysisInput) -> str:
    """Analyze key performance indicators"""
    try:
        # Load data using cached approach with fallback
        df = get_cached_data(input_data.data_path)
